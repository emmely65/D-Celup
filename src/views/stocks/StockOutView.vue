...
async function submit() {
  // BUG-12b: Validasi client-side sebelum submit
  ...
  try {
    ...
    await stockMovementApi.stockOut(payload)
    uiStore.showToast('success', 'Barang keluar berhasil dicatat')
...
<template>
  <DashboardLayout>
    <template #header-text>
      <h1 class="truncate text-lg font-extrabold text-dcelup-text">Barang Keluar</h1>
    </template>
